    ...
    <>
      ...
      <nav id="sidebar" className={`fixed inset-y-0 left-0 z-50 w-64 p-6 glass backdrop-blur-xl transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out flex flex-col space-y-6 lg:hidden`}>
        ...
        <ul className="space-y-4 text-white font-medium">
          <li><a href="mailto:support@espotive.in" onClick={toggleSidebar} className="block hover:text-red-400 transition">Contact Us</a></li>
          <li><a href="mailto:work@espotive.in" onClick={toggleSidebar} className="block hover:text-red-400 transition">Work With Us</a></li>
          <li>
            ...
            <ul id="social-links" className={`mt-2 space-y-2 ${isSocialsOpen ? '' : 'hidden'} pl-3`}>
              <li><a href="#" onClick={toggleSidebar} className="block hover:text-red-400">Instagram</a></li>
              <li><a href="#" onClick={toggleSidebar} className="block hover:text-red-400">Discord</a></li>
              <li><a href="#" onClick={toggleSidebar} className="block hover:text-red-400">YouTube</a></li>
              <li><a href="#" onClick={toggleSidebar} className="block hover:text-red-400">X</a></li>
              <li><a href="#" onClick={toggleSidebar} className="block hover:text-red-400">WhatsApp Channel</a></li>
            </ul>
          </li>
        </ul>
      </nav>
